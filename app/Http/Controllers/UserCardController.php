...
class UserCardController extends Controller
{
	...
	public function googlepaytest(Request $request)
	{
    ...
    public function addcard(Request $request)
    {
        try{
			...
			if($request->type == 'profile')
			{
				$users = Profile::with('interests','community_list','community_list.community_info','user_info')->find($request->profile_id);
			}
			else
			{
				$users = User::find(Auth::user()->id);
